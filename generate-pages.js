...
<style>
  * { box-sizing: border-box; }
  ...
  @media (min-width: 768px) {
    .title { font-size: 21px; }                    /* 1 - titolo un po' più grande */
    .subtitle { font-size: 13.5px; }
    .source-inline { font-size: 12.5px; }
    .title-group { padding-left: 150px; }          /* 2 - spostato a destra come volevi (150px) */
  }

  /* ====================== MOBILE / SMARTPHONE ====================== */
  @media (max-width: 767px) {
    .title { font-size: 16.5px; }                  /* 1 - titolo ridotto */
    .subtitle { font-size: 11.5px; }
    .source-inline { font-size: 10.5px; }
    .title-group { padding-left: 8px; }            /* 2 - quasi al margine sinistro */
    
    /* 3 - nascondi solo le frecce prev/next su mobile */
    #prev-btn, #next-btn { display: none !important; }
    
    /* pulsanti rimanenti (fullscreen, screenshot, social) tutti a destra */
    .actions { justify-content: flex-end; gap: 4px; }
