...
.subtitle a:hover { opacity: 1; }

/* Pulsanti Azione (Top Right) */
...
/* Area Grafico e Navigazione */
#capture-area { background: #0f172a; padding: 10px; border-radius: 8px; }
...
.nav-btn:hover { background: rgba(51, 65, 85, 0.9); transform: scale(1.1); }
.nav-btn svg { width: 24px; height: 24px; stroke-width: 2.5; }

.source { margin-top:15px; font-size:14px; color:#94a3b8; }
...
<div class="container">
  ...
  <div class="header-row">
    ...
    <div class="actions">
      <button class="action-btn" onclick="takeScreenshot()" title="Download Chart">
        <svg viewBox="0 0 24 24"><path d="M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z"/></svg>
      </button>
      <a class="action-btn" href="https://twitter.com/intent/tweet?url=${currentUrl}&text=${title}" target="_blank">
      ...
      <a class="action-btn" href="https://www.facebook.com/sharer/sharer.php?u=${currentUrl}" target="_blank">
  ...
  <div id="capture-area">
    <div class="chart-wrapper">
      ...
      <div class="nav-overlay">
        ${prev ? `<a class="nav-btn" href="${prev}.html" title="Previous"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M15 18l-6-6 6-6"/></svg></a>` : ''}
        ${next ? `<a class="nav-btn" href="${next}.html" title="Next"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M9 18l6-6-6-6"/></svg></a>` : ''}
      </div>
    </div>
...
function takeScreenshot() {
    ...
    // Nascondi frecce per lo screenshot
