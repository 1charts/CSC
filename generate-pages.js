...
/* ====================== LAPTOP / DESKTOP ====================== */
  @media (min-width: 768px) {
    /* 1. Gestione globale della riga Header */
    .header-row { 
      height: auto;           /* Rimuove l'altezza fissa per darti libertà */
      min-height: 80px;       /* Altezza minima per non schiacciare */
      
      /* --- INTERVIENI QUI PER POSIZIONARE --- */
      padding-top: 30px;      /* ABBASSA gli elementi dal bordo superiore */
      padding-left: 10%;      /* SPOSTA il titolo verso il centro (usa px o %) */
      padding-right: 10%;     /* SPOSTA i bottoni verso il centro (usa px o %) */
      margin-bottom: 20px;    /* Allontana l'header dal grafico */
    }

    /* 2. Regolazioni Testi */
    .title { 
      font-size: 24px;        /* Titolo leggermente più grande su desktop */
    }
    .subtitle { 
      font-size: 14px; 
    }
    .source-inline { 
      font-size: 13px; 
      display: block;         /* Mette le fonti sotto il sottotitolo se vuoi */
      margin-top: 4px;
    }

    /* 3. Reset dei vecchi valori */
    .title-group { 
      padding-left: 0;        /* Eliminiamo il vecchio padding fisso */
    }

    /* 4. Dimensioni Grafico */
    .chart-container img {
      max-width: 85%;
      max-height: 85%;
    }
    
    /* Se vuoi che i bottoni siano più grandi o distanziati su desktop */
    .actions {
      gap: 12px;
    }
  }
